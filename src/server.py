...
from mesa.visualization import Slider, StaticText, Checkbox, ModularServer, Choice
...
model_parameters = {
    ...
    'num_firetruck': Slider ("Number of Firetrucks", 30, 0, 50, 1),
    'truck_max_speed': Slider("Speed of Firetrucks", 20, 1, 30, 1),
    'steps_to_extinguishment': Slider("Number of steps needed to extinguish a fire",
                                                     1, 1, 6, 1),
    'placed_on_edges': Checkbox("Place firetrucks on the edges of the grid", value=True),
    # Creating a dropdown from which the user can choose the firetruck fire fighting strategy
    'truck_strategy': Choice ("Firetrucks strategy", value='Indirect attack',
    ...
    'text_other_settings': StaticText("Other Settings"),
    'wind_strength': Slider( "Wind strength", 10, 0, 80, 1),
    'wind_dir': Choice ("Wind Direction", value=('\u2B07 South'),
                                      choices=["\u2B06  North", "\u2197 North/East", "\u27A1 East",
                                               "\u2198 South/East", "\u2B07 North",
                                               "\u2199 South/West", "\u2B05 West",
                                               "\u2196 North/West"]),
    'random_fires': Checkbox ("Spontaneous Fires (Temperature based)", value=False),
    'temperature': Slider ("Temperature (°C)", 20, 0, 60, 1,)}
